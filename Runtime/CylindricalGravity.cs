...
namespace AdvancedGravity
{
    public sealed class CylindricalGravity : GravityField
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            GravityGizmos.DrawWireCylinder(Vector3.zero, rotation, _minimumRange + _minimumFade, _length * 2);
            ...
            GravityGizmos.DrawWireCylinder(Vector3.zero, rotation, _minimumRange, _length * 2);
        }
#endif
        #endregion
